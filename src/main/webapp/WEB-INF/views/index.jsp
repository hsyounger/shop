...
<div class="banner_y center">
  <div class="nav">
    <c:forEach items="${applicationScope}">
...
<div class="danpin center">
  ...
  <div class="main center">
    <c:forEach items="${applicationScope.mapList}" var="sprcouct">
      <div class="mingxing fl">
        <div class="sub_mingxing"><a href=""><img src="${sprcouct.image}" alt=""></a></div>
        <div class="pinpai"><a href="">${sprcouct.name}</a></div>
        <div class="youhui">${sprcouct.description}</div>
        <div class="jiage">${sprcouct.price}</div>
      </div>
    </c:forEach>
    <%--<div class="mingxing fl">
