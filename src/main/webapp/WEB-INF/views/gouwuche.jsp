    ...
    <div class="gwcxd center">
        ...
        <c:forEach items="${requestScope.list}" var="list">
            <div class="content2 center">
                ...
                <div class="sub_content fl"><img src="${list.image}"></div>
                <div class="sub_content fl ft20">${list.name}</div>
                <div class="sub_content fl ">${list.price}</div>
                <div class="sub_content fl">
                    <input class="shuliang" type="number" value="${list.counts}" step="1" min="1" >
                </div>
                <div class="sub_content fl">${list.total}</div>
    ...
    <div class="jiesuandan mt20 center">
        <div class="tishi fl ml20">
            <ul>
                ...
                <li>|</li>
                <li>共<span>${list.counts}</span>件商品，已选择<span>1</span>件</li>
                <div class="clear"></div>
            </ul>
        </div>
        <div class="jiesuan fr">
            <div class="jiesuanjiage fl">合计（不含运费）：<span>${list.total}</span></div>
